...
export const developmentAdvice: Record<string, {
  ...
  'k5': {
    ...
    focus: 'この時期は脳と神経系が急速に発達し、大人の約90%まで成長します。多様な動き（走る・跳ぶ・投げる・回る・バランスをとる）を経験することで、運動神経の土台が形成されます。一つの運動に特化するよりも、様々な動きを「遊び」として楽しむことが、将来の運動能力を決定づける最も重要な時期です。',
    key: '「楽しい」という感情を最優先に、鬼ごっこ・ボール遊び・アスレチックなど、遊びの中で自然に体を動かすことが効果的です。親子で一緒に体を動かすことで、運動への意欲も高まります。',
    avoid: '同じ動作の反復練習や勝ち負けへの過度なこだわりは、運動嫌いの原因になりかねません。この時期は「できた！」という成功体験を積み重ねることが大切です。'
  },
  '1': {
    golden: 'プレゴールデンエイジ（5-8歳）',
    focus: 'この時期は脳と神経系が急速に発達し、大人の約90%まで成長します。多様な動き（走る・跳ぶ・投げる・回る・バランスをとる）を経験することで、運動神経の土台が形成されます。一つの運動に特化するよりも、様々な動きを「遊び」として楽しむことが、将来の運動能力を決定づける最も重要な時期です。',
  ...
  '3': {
    ...
    focus: '人生で最も運動神経が発達する「ゴールデンエイジ」の始まりです。この時期に習得した動きは一生忘れません。「見たらすぐにできる」「即座の習得」が可能な貴重な時期であり、様々なスポーツの基本技術を効率的に身につけることができます。プロスポーツ選手の多くが、この時期に専門競技の基礎を習得しています。',
    key: '正しいフォームを「見せて」覚えさせることが最も効果的です。動画やお手本を見せながら、細かい技術を丁寧に教えましょう。複数のスポーツを経験することで、応用力も身につきます。',
    avoid: '筋力トレーニングはまだ早い段階です。技術習得とコーディネーション能力の向上を優先し、成長期の体に過度な負担をかけないようにしましょう。'
  },
  '4': {
    golden: 'ゴールデンエイジ（9-12歳）',
    focus: '人生で最も運動神経が発達する「ゴールデンエイジ」の真っ只中です。この時期に習得した動きは一生忘れません。複雑な動きも「見ただけでできる」という驚くべき学習能力を発揮します。様々なスポーツの基本技術を短期間で身につけることができる、運動能力向上のゴールデンタイムです。',
    key: '「即座の習得」が可能なこの時期に、様々な基本技術を経験させることが重要です。一つのスポーツだけでなく、複数のスポーツを経験することで、総合的な運動センスが磨かれます。',
    avoid: '過度な筋力トレーニングは成長を妨げる可能性があります。技術練習を重視し、体への負担は適度に抑えましょう。勝利へのこだわりすぎにも注意が必要です。'
  },
  '5': {
    golden: 'ゴールデンエイジ（9-12歳）',
    focus: '運動神経発達の黄金期も後半に差し掛かっています。この時期に身につけた運動能力は生涯の財産となります。より複雑で高度な技術の習得も可能になり、専門的な練習にも取り組める時期です。体の成長とともに、持久力や筋力も徐々に向上してきます。',
    key: '複雑な動きも習得可能な時期です。専門的な技術練習に取り組みつつ、基礎体力の向上も図りましょう。自分に合ったスポーツを見つける良い機会でもあります。',
    avoid: '勝利至上主義に陥らないよう注意が必要です。運動を「楽しむ」気持ちとのバランスを大切にし、燃え尽き症候群を防ぎましょう。'
  },
  '6': {
    golden: 'ゴールデンエイジ終盤',
    focus: 'ゴールデンエイジの終盤から「ポストゴールデンエイジ」への移行期です。体格差が出始め、心肺機能も発達する時期です。これまでに培った運動神経を活かしながら、体力面の強化も視野に入れていく段階です。中学生に向けて、より専門的なトレーニングへの準備が始まります。',
    key: '持久力トレーニングを少しずつ導入し、体力の向上を図ることができます。専門競技への取り組みを本格化させつつ、怪我予防のためのストレッチも習慣化しましょう。',
    avoid: '急激な筋力トレーニングは避け、徐々に負荷を上げていくことが大切です。成長期のオーバーワークは怪我の原因になるため、休養とのバランスを意識しましょう。'
  }
}
