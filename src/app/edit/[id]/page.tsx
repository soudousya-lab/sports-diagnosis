...
import { runDiagnosis, categories, estimate15mTime, ballWeightCorrections } from '@/lib/diagnosis'
    ...
    async function fetchData() {
      try {
        ...
        setFormData({
          ...
          ballWeight: measurement.ball_weight || '1kg'
        })
      } catch (error) {
