      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14 sm:h-16 md:h-20">
            ...
            <nav className="hidden md:flex items-center gap-8 lg:gap-10">
              ...
              <Link href="/business/pricing" className="text-sm text-gray-600 hover:text-blue-600 transition-colors">料金</Link>
              <a href="#faq" className="text-sm text-gray-600 hover:text-blue-600 transition-colors">よくある質問</a>
              <Link href="/business/contact" className="px-5 py-2 bg-blue-600 text-white text-sm rounded-lg font-medium hover:bg-blue-700 transition-colors">
                お問い合わせ
              </Link>
            </nav>
        ...
        <div className={`md:hidden bg-white border-t border-gray-100 overflow-hidden transition-all duration-300 ${mobileMenuOpen ? 'max-h-96 py-4' : 'max-h-0'}`}>
          <div className="px-4 space-y-3">
            ...
            <Link href="/business/pricing" className="block text-gray-600 hover:text-blue-600 py-2 text-sm" onClick={() => setMobileMenuOpen(false)}>料金</Link>
            <a href="#faq" className="block text-gray-600 hover:text-blue-600 py-2 text-sm" onClick={() => setMobileMenuOpen(false)}>よくある質問</a>
            <Link href="/business/contact" className="block w-full text-center px-6 py-3 bg-blue-600 text-white rounded-lg font-medium text-sm">
              お問い合わせ
            </Link>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-gray-500">
                ...
                <li><Link href="/business/pricing" className="hover:text-blue-600 transition-colors">料金</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-gray-500">
                <li><Link href="/business/contact" className="hover:text-blue-600 transition-colors">導入のご相談</Link></li>
