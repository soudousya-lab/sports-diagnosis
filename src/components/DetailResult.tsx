      ...
      <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="flex justify-between items-start p-6 border-b-4 border-blue-900">
          ...
          <div className="text-right text-xs text-gray-600">
            <div className="inline-block px-3 py-1 bg-blue-900 text-white font-bold rounded mb-1">DETAIL</div>
            <div>測定日: {today}</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-5 p-6">
          ...
          <div>
            ...
            <div className="border border-gray-200 p-4 rounded-lg text-sm leading-relaxed mb-4">
              ...
              <h4 className="text-blue-900 font-bold mb-2 pb-2 border-b-2 border-blue-900">
            ...
            <div className="border border-gray-200 p-4 rounded-lg">
              ...
              <div className="flex flex-wrap gap-2 mb-3">
                {result.sportsAptitude.slice(0, 3).map(sport => (
                  <span
                    key={sport.name}
                    className="inline-block px-3 py-1 bg-yellow-500 text-gray-800 rounded-full text-xs font-medium"
                  >
              ...
              <div className="flex flex-wrap gap-2">
                {result.sportsAptitude.slice(3, 6).map(sport => (
                  <span
                    key={sport.name}
                    className="inline-block px-3 py-1 bg-blue-900 text-white rounded-full text-xs font-medium"
                  >
                    {sport.icon} {sport.name}
                  </span>
                ))}
              </div>
              <p className="mt-3 text-[9px] text-gray-600">※興味・関心も重要です。本人の意志を尊重してください。</p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="border border-gray-200 p-4 rounded-lg mb-4">
              <ul className="space-y-3">
                {trainings.map((t, i) => (
                  <li key={i} className="flex gap-3 pb-3 border-b border-gray-200 last:border-b-0 last:pb-0">
                    <span className="w-6 h-6 bg-blue-900 text-white rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0">
                      {i + 1}
                    </span>
            ...
            <div className="bg-gray-50 border border-gray-200 p-4 rounded-lg text-[10px] leading-relaxed">
              <h4 className="text-xs font-bold text-gray-800 mb-2">【発達段階】{devAdv.golden}</h4>
              <p className="mb-3">{devAdv.focus}</p>
              <h4 className="text-xs font-bold text-gray-800 mb-2">【この時期のポイント】</h4>
              <p className="mb-3">{devAdv.key}</p>
              <h4 className="text-xs font-bold text-red-600 mb-2">【注意点】</h4>
